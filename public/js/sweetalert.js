  ...
  const Ut = (e) => {
    ...
    Wt = (t, n, o) => {
      n.container.onclick = (i) => {
        ...
        Rt
          ? (Rt = !1)
          : i.target === n.container && u(s.allowOutsideClick) && o(He.backdrop)
      }
    },
    zt = (e) =>
