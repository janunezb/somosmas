...
@section('content')
    ...
    <section id="poldeseguridad" class="container d-flex justify-content">
        <div class="row">
            <div class="col-6 p-3">
                ...
                <p>
                    <i class="bi bi-check-circle p-2"></i> Identificar, evaluar y controlar los agentes y factores de
                    riesgos derivados de condiciones peligrosas y actos sub estándares presentes en el medio de trabajo, que
                    puedan causar accidentes o alteraciones en la salud de los colaboradores y socializarlos.
                </p>
                <p>
                    <i class="bi bi-check-circle p-2"></i> Diseñar, implementar y evaluar el desarrollo del Sistema de
                    Gestión en Seguridad y Salud en el trabajo.
                </p>
                <p>
                    <i class="bi bi-check-circle p-2"></i> Desarrollar un plan de capacitación en temas relacionados con el
                    Sistema de Gestión de Seguridad y Salud en el Trabajo.
                </p>

                <p>
                    <i class="bi bi-check-circle p-2"></i> Cumplir con los requisitos legales que en materia de seguridad y
                    salud en el trabajo apliquen a la empresa.
                </p>
                <p>
                    <i class="bi bi-check-circle p-2"></i> Desarrollar, implementar y hacer seguimiento a campañas de
                    estilos de vida saludables generando la cultura del auto-cuidado.
                </p>
            </div>
            <div class="col-6">
                <img src="{{ asset('images/portales/about1.jpg') }}" alt="">
            </div>

            <div class="col-6">
                <h4>Etapas 1 a la 4 del SGSST</h4>
                <p>
                    <a href="#etapa1" class="btn"><i class="bi bi-check-circle p-2"></i>1.Recursos humanos, financieros,
                        técnicos entre otros.</a>
                    <br>
                    <a href="#etapa2" class="btn"><i class="bi bi-check-circle p-2"></i>2.Programa de formación SGSST,
                        medio ambiente y seguridad Vial.</a>
                    <br>
                    <a href="#etapa3" class="btn"><i class="bi bi-check-circle p-2"></i>3.Política SGSST revisada por el
                        representante legal.</a>
                    <br>
                    <a href="#etapa4" class="btn"><i class="bi bi-check-circle p-2"></i>4.Definición de objetivos: SGSST,
                        seguridad vial y medio ambiente.</a>
                </p>
            </div>
        </div>
    </section>
    ...
    <div class="cuadrado">
        <div class="row">
            <div class="col-12 fs-2">
                Fases del sistema de gestión: Política SGSST revisada por el representante legal, divulgada y realizada
                conforme dec 1072 de 2015.
            </div>
        </div>
    </div>
    ...
    <section id="" class="container d-flex justify-content">
        <div class="col-6">
            ...
            <p>
                <a href="#etapa1" class="btn"><i class="bi bi-check-circle p-2"></i>1.Recursos humanos, financieros,
                    tecnicos entre otros.</a>
                <br>
                <a href="#etapa2" class="btn"><i class="bi bi-check-circle p-2"></i>2.Programa de formacion SGSST,
                    medio ambiente y seguridad Vial.</a>
                <br>
                <a href="#etapa3" class="btn"><i class="bi bi-check-circle p-2"></i>3.Politica SGSST revisada por el
                    representante legal.</a>
                <br>
                <a href="#etapa4" class="btn"><i class="bi bi-check-circle p-2"></i>4.Definicion de objetivos:
                    SGSST,seguridad vial y medio ambiente.</a>
            </p>
        </div>
    </section>
    <section id="" class="container d-flex justify-content">
        <div class="col-6">
            <a href="{{ route('admin.index') }}" class="btn"><img src="{{ asset('images/iconoliwa.png') }}"
                    alt="" width="120" height="100">Liwa SGSST</a>
