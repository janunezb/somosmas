      ...
      <div class="col-4 offset-2">
        <div class="card" style="width:;">
          ...
          <div class="card-body">
            ...
            <a href="https://forms.gle/69qYRLGjVD9cTrNb9" class="btn btn-outline-success" target="_blank"><i class="bi bi-arrow-right"></i> Ingresa</a>
          </div>
        </div>
      </div>
      <div class="col-4">
        <div class="card" style="width:;">
          ...
          <div class="card-body">
            ...
            <p>Tiempo estimado 5 minutos.</p>
            <a href="https://forms.gle/nVyxfLoVoxeaxMwX7" class="btn btn-outline-success" target="_blank"><i class="bi bi-arrow-right"></i> Ingresa</a>
          </div>
      </div>
        </div>
      </div>
...
<section id="redapoyo" class="d-flex justify-content-center align-items-center p-3">
    <div class="footer">
  <div class="row">
      <div class="col-4">
          ...
          <p>Red de apoyo en caso de emergencia: Navega, Libre, Liwa, Suncoenergy, Suncolombia. Recuerde: Numero general de emergencias: 123
              ...
              <a href="https://wa.me/573118076877/?text=Soy%20tu%20apoyo%20en%20Navega" class="btn btn-success"><i class="bi bi-whatsapp"></i></a>
              <a href="https://api.whatsapp.com/send?phone=573016373640&text=Soy%20tu%20apoyo%20en%20Libre." class="btn btn-success"><i class="bi bi-whatsapp"></i></a>
              <a href="https://api.whatsapp.com/send?phone=573245522551&text=Soy%20tu%20apoyo%20en%20Bogota." class="btn btn-success"><i class="bi bi-whatsapp"></i></a>
              <a href="https://api.whatsapp.com/send?phone=573223097701&text=Soy%20tu%20apoyo%20en%20Bogota." class="btn btn-success"><i class="bi bi-whatsapp"></i></a>
              <p></p>
