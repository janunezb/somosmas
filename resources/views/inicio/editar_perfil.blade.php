...
<div class="container d-flex justify-content-center">
    ...
    <div class="form-body">
        <h2 class="titulo4">Información Personal</h2>
        <div class="content">
            <div class="row">
                <div class="col">
                    ...
                    <div class="box1">
                        ...
                        <label class="label" for="empresa">Empresa</label>
                            <input disabled type="text" value="{{ auth()->user()->empresa_id }}" class="input border border-gray-00 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-1 my-1" name="empresa">                
                        </div>
                        ...
                        <p class="caracteres">*Si deseas actualizar algún dato personal favor comunicarse con el administrador.* </p>
                    </div>
