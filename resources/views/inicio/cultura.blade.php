...
<body>
    <main class="container d-flex justify-content-center align-items-center p-5">
        ...
        <div class="container text-center aling-items-center">
                    ...
                    <div class="col-6 hola pt-3 fondo1 ">
                        ...
                        <p>¿Quiénes hacen parte de nuestro comité?
                            ...
                            <div class="azul h6">
                                ...
                                <p> Pronto conocerás mas sobre nosotros, algunas de las actividades que hemos realizado y como puedes hacer parte de ellas.</p>
            ...
            <section id="comite" class="d-flex justify-content-center align-items-center p-2">
                <div class="row aling items center">
                    ...
                    <div class="col-12 texto">
                        <p>Quien dijo que el tiempo no se puede detener, disfruta de esta galeria.</p>
                    </div>
      ...
      <section id="redapoyo" class="d-flex justify-content-center align-items-center p-5">
        <div class="footer">
         <div class="row">
          <div class="col-4">
