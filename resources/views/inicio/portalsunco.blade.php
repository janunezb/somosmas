...
<head>
    ...
    <title>Portal SuncoEnergy</title>
...
<body>
    <nav class="navbar navbar-expand-lg bg-dark sticky-top">
        <div class="container-fluid">
                <a class="navbar-brand" href="{{route('inicio.portalsunco')}}"> SuncoEnergy</a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a class="nav-link" href="{{route('inicio.portalsunco')}}">Inicio</a>
              </li>
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <li><a class="dropdown-item" href="{{route('inicio.etapa5sunco')}}">Etapas 5 a la 9</a></li>
                  <li><a class="dropdown-item" href="{{route('inicio.etapa10sunco')}}">Etapas 10 a la 14</a></li>
                  <li><a class="dropdown-item" href="{{route('inicio.etapa15sunco')}}">Etapas 15 a la 19</a></li>
                  <li><a class="dropdown-item" href="{{route('inicio.etapa20sunco')}}">Etapas 20 a la 22</a></li>
                </ul>
              </li>
            </ul>
      ...
      <div class="cuadrado">
        ...
        <section id="" class="container d-flex justify-content">
            <div class="col-6">
                <a href="{{route('inicio.portalsunco')}}" class="btn"><img src="{{asset('images/logos/sunco.png')}}" alt="" width="120" height="100">SuncoEnergy SGSST</a>
