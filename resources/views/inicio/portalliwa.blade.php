...
<body>
    <nav class="navbar navbar-expand-lg bg-dark sticky-top">
        <div class="container-fluid">
                <a class="navbar-brand" href="{{route('inicio.portalliwa')}}"> Liwa</a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a class="nav-link" href="{{route('inicio.portalliwa')}}">Inicio</a>
              </li>
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <li><a class="dropdown-item" href="{{route('inicio.etapa5liwa')}}">Etapas 5 a la 9</a></li>
                  <li><a class="dropdown-item" href="{{route('inicio.etapa10liwa')}}">Etapas 10 a la 14</a></li>
                  <li><a class="dropdown-item" href="{{route('inicio.etapa15liwa')}}">Etapas 15 a la 19</a></li>
                  <li><a class="dropdown-item" href="{{route('inicio.etapa20liwa')}}">Etapas 20 a la 22</a></li>
                </ul>
              </li>
            </ul>
            <li class="mx-8">
      ...
      <div class="cuadrado">
        ...
        <section id="" class="container d-flex justify-content">
            <div class="col-6">
                <a href="{{route('inicio.portalliwa')}}" class="btn"><img src="{{asset('images/iconoliwa.png')}}" alt="" width="120" height="100">Liwa SGSST</a>
